      ...
      <div class="modal-body">
            <form>
                    <div class="form-group">
                        ...
                        <input class="login-input quick-add-inputs" type="text" placeholder="Amount">
                    </div>
                    <div class="form-group">
                        <label class="label-title" for="exampleInputAmount">Description</label>
                        <textarea class="login-input quick-add-inputs" type="number" placeholder="Description"></textarea>
                    </div>
