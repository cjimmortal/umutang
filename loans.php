        ...
        <div class="loans-data" id="loans-data"> 
              <div class="page-title-pagination">
                    ...
                    <div class="div-title-page">
                        <p class="title-page">Loans / <span>Unpaid Loans</span></p>
                    </div>
                    <div class="pagination">
                        <button data-toggle="modal" data-target="#addLoansModal" class="btn-add-loans">Add New Loans</button>
                    </div>
              </div>
            <!-- unpaid -->
              <div class="loans-loans col-sm-12">
                  <div class="d-loans-content">
                    <div class="div-title-page">
                        <p class="loans-title-3">Unpaid Loans</p>
                    </div>    
                    ...
                    <table class="loans-table" id="loans-table">
                        <tr>
                            <th >IDnumber</th>
                            <th>Name</th>
                            <th>Borrowed</th> 
                        ...
                        <?php $get = new display(); $get->displayLoanData();  ?>
                    </table>
                    <br>
                  </div>
              </div>
            <!-- paid -->
              <div class="loans-loans col-sm-12">
                  <div class="d-loans-content">
                    <div class="div-title-page">
                        <p class="loans-title-3">Paid Loans</p>
                    </div>     
                    ...
                    <table class="loans-table" id="loans-table">
                        ...
                        <?php $get = new display(); $get->displayShowUnpaidLoanData();  ?>
                    </table>
                    <br>
                  </div>
              </div>
